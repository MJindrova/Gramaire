# Language Broadcast Message
 How to create multilanguage GUI? 
...
|2|`10`|String ID (number for this example)|
|3|`MyCaption`|Callback method. This method will be call after property set.|
